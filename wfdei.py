...
def make_nav_latlon( lat, lon ) : 
    ...
    1D variables lat and lon. The WFDEI data are already on quarter degree
    cell boundaries (x.75,x.25) so we don't need to add anything like we
    needed to with cruncep."""
